...
class RectifiedFlow:
    ...
    def get_velocity(
        ...
        **kwargs,
        ...
        velocity = self.velocity_field(x_t, t,x_cond=x_cond, **kwargs)
        return velocity

    def get_loss(self, x_0: torch.Tensor | None, x_1: torch.Tensor, t: torch.Tensor | None = None, x_cond: torch.Tensor = None, **kwargs):
